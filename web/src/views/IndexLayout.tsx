...
// 示例组件
function Option5() { return <div>Option 5 Content</div> }
function Option6() { return <div>Option 6 Content</div> }
function Home() { return <div>欢迎欢迎</div> }
...
const AppLayout = () => {
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout>
        <Sider width={200} style={{ background: '#e1ecf7' }} collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
