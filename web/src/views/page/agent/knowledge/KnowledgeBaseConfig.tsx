...
const KnowledgeBaseConfig: React.FC<{ agentId?: number }> = ({agentId}) => {
    ...
    const [uploadMode, setUploadMode] = useState<'file' | 'text'>('file'); // 上传模式：文件或文本
    const [pasteImagePreview, setPasteImagePreview] = useState<string | null>(null); // 粘贴的图片预览
    ...
    useEffect(() => {
        ...
        return () => {
            console.log('Unloading paste event listener');
        ...
        <div>
            <div style={{marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                <div>
                    ...
                    <Text type="secondary">管理Agent的知识库，支持文本、PDF文档和图片（OCR识别）上传</Text>
                </div>
                <Space>
                    <Button
                        type="primary"
                                        ...
                                        <div style={{
                                            ...
                                            {pasteImagePreview && (
                                                <div style={{marginTop: 12}}>
                                                    <div
                                                        style={{color: '#999', fontSize: '12px', marginBottom: 8}}>图片预览：
                                                    </div>
                                                    <img
