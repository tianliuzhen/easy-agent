...
import com.aaa.easyagent.common.llm.deepseek.OpenAiApi.ChatCompletion;
import com.aaa.easyagent.common.llm.deepseek.OpenAiApi.ChatCompletion.Choice;
import com.aaa.easyagent.common.llm.deepseek.OpenAiApi.ChatCompletionMessage;
import com.aaa.easyagent.common.llm.deepseek.OpenAiApi.ChatCompletionMessage.AudioOutput;
import com.aaa.easyagent.common.llm.deepseek.OpenAiApi.ChatCompletionMessage.ChatCompletionFunction;
import com.aaa.easyagent.common.llm.deepseek.OpenAiApi.ChatCompletionMessage.MediaContent;
import com.aaa.easyagent.common.llm.deepseek.OpenAiApi.ChatCompletionMessage.ToolCall;
import com.aaa.easyagent.common.llm.deepseek.OpenAiApi.ChatCompletionRequest;
...
public class OpenAiChatModel extends AbstractToolCallSupport implements ChatModel {
    ...
    public static final class Builder {
        ...
        public OpenAiChatModel.Builder openAiApi(OpenAiApi openAiApi) {
            this.openAiApi = openAiApi;
            return this;
        }
        ...
        @Deprecated
        public OpenAiChatModel.Builder functionCallbackResolver(FunctionCallbackResolver functionCallbackResolver) {
            this.functionCallbackResolver = functionCallbackResolver;
            return this;
        }

        @Deprecated
        public OpenAiChatModel.Builder toolFunctionCallbacks(List<FunctionCallback> toolFunctionCallbacks) {
            this.toolFunctionCallbacks = toolFunctionCallbacks;
            return this;
        }

        public OpenAiChatModel.Builder retryTemplate(RetryTemplate retryTemplate) {
            this.retryTemplate = retryTemplate;
            return this;
        }

        public OpenAiChatModel.Builder observationRegistry(ObservationRegistry observationRegistry) {
            this.observationRegistry = observationRegistry;
            return this;
        }
