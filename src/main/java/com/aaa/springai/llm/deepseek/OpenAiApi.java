...
public class OpenAiApi {
     ...
     *                            {@link ChatCompletionRequest.ToolChoiceBuilder} to create the tool choice value.
    ...
    public record ChatCompletionRequest(// @formatter:off
                                        ...
                                        @JsonProperty("audio") ChatCompletionRequest.AudioParameters audioParameters,
                                        ...
                                        @JsonProperty("stream_options") ChatCompletionRequest.StreamOptions streamOptions,
         ...
         */
        public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, ChatCompletionRequest.AudioParameters audio, boolean stream) {
        ...
        /**
         * Sets the {@link ChatCompletionRequest.StreamOptions} for this request.
         *
         ...
         */
        public ChatCompletionRequest streamOptions(ChatCompletionRequest.StreamOptions streamOptions) {
        ...
        public record AudioParameters(
                @JsonProperty("voice") ChatCompletionRequest.AudioParameters.Voice voice,
                @JsonProperty("format") ChatCompletionRequest.AudioParameters.AudioResponseFormat format) {
     ...
     *
     * @param rawContent  The contents of the message. Can be either a {@link ChatCompletionMessage.MediaContent}
     *                    or a {@link String}. The response message content is always a {@link String}.
     * @param role        The role of the messages author. Could be one of the {@link ChatCompletionMessage.Role}
     *                    types.
     ...
     *                    the {@link ChatCompletionMessage.Role#TOOL} role and null otherwise.
     * @param toolCalls   The tool calls generated by the model, such as function calls.
     *                    Applicable only for {@link ChatCompletionMessage.Role#ASSISTANT} role and null otherwise.
     * @param refusal     The refusal message by the assistant. Applicable only for
     *                    {@link ChatCompletionMessage.Role#ASSISTANT} role and null otherwise.
    ...
    public record ChatCompletionMessage(// @formatter:off
                                        ...
                                        @JsonProperty("audio") ChatCompletionMessage.AudioOutput audioOutput) { // @formatter:on
        ...
        public record MediaContent(// @formatter:off
                                   ...
                                   @JsonProperty("input_audio") ChatCompletionMessage.MediaContent.InputAudio inputAudio) { // @formatter:on
             ...
             */
            public MediaContent(ChatCompletionMessage.MediaContent.InputAudio inputAudio) {
            ...
            public record InputAudio(// @formatter:off
                                     ...
                                     @JsonProperty("format") ChatCompletionMessage.MediaContent.InputAudio.Format format) {
        ...
        public record ToolCall(// @formatter:off
                               ...
                               @JsonProperty("type") String type,
                               @JsonProperty("function") ChatCompletionMessage.ChatCompletionFunction function) { // @formatter:on

            public ToolCall(String id, String type, ChatCompletionMessage.ChatCompletionFunction function) {
    ...
    public record LogProbs(
            ...
            @JsonProperty("refusal") List<LogProbs.Content> refusal) {
        ...
        public record Content(// @formatter:off
                              ...
                              @JsonProperty("top_logprobs") List<LogProbs.Content.TopLogProbs> topLogprobs) { // @formatter:on
    ...
    public record Usage(// @formatter:off
                        ...
                        @JsonProperty("prompt_tokens_details") Usage.PromptTokensDetails promptTokensDetails,
                        @JsonProperty("completion_tokens_details") Usage.CompletionTokenDetails completionTokenDetails,
